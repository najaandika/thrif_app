                    ...
                    <section class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-6 space-y-5">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-2">
                                ...
                                @endif
                                <p class="text-3xl font-bold text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text pt-2">Rp {{ number_format($product->price, 0, ',', '.') }}</p>
                            </div>
                        </div>
                        ...
                        <form method="POST" action="{{ route('landing.products.order', $product) }}" class="space-y-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="grid gap-4 sm:grid-cols-2">
                                    <div class="space-y-1">
                                        ...
                                        <input type="number" name="quantity" min="1" max="{{ $product->stock }}" value="{{ $prefilledQuantity }}" class="{{ $inputClass }}" required>
                                        <p class="text-[11px] text-gray-500 dark:text-gray-400">Maksimum {{ $product->stock }} item tersedia.</p>
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <textarea name="notes" rows="3" class="{{ $inputClass }}" placeholder="Contoh: request ukuran, packing">{{ $prefill['notes'] }}</textarea>
                                        @error('notes', 'order')
                                            <p class="text-xs text-red-500">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center gap-2">
                                    ...
                                    <p class="{{ $labelClass }}">Ringkasan Order</p>
                                </div>
                                <div class="rounded-2xl border-2 border-gray-200 dark:border-gray-700 p-5 bg-gradient-to-br from-gray-50 to-gray-100/50 dark:from-gray-800/40 dark:to-gray-800/20 space-y-3 text-sm text-gray-700 dark:text-gray-200">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="font-semibold">{{ $prefilledQuantity }} pcs</span>
                                    </div>
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center gap-3 pt-1">
                                <button type="submit" id="submit-order-btn" aria-live="polite" class="inline-flex items-center justify-center gap-2 flex-1 rounded-2xl bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-3.5 text-sm font-semibold text-white shadow-xl shadow-indigo-500/50 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-indigo-500/50 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100">
