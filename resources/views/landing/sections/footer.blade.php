                ...
                <ul class="space-y-2 text-xs text-gray-600 dark:text-gray-400">
                    ...
                    @auth
                        @if(auth()->user()->isCustomer())
                            ...
                            <li><a href="{{ route('landing.orders.history') }}" class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors inline-block">Riwayat Order</a></li>
                        @else
                            <li><a href="{{ route('dashboard') }}" class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors inline-block">Dashboard</a></li>
                        @endif
                    @endauth
                </ul>
            </div>
                ...
                <div class="space-y-2.5">
                    ...
                    <div class="flex items-start gap-2.5 text-xs text-gray-600 dark:text-gray-400">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="font-medium leading-snug">{{ $shopAddress }}</p>
                        </div>
                    </div>
                    @endif
                </div>
