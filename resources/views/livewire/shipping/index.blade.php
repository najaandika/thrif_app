                ...
                <div class="bg-white dark:bg-gray-800 shadow-xl rounded-2xl overflow-hidden border-l-4 border-indigo-500">
                    ...
                    <form wire:submit="save" class="p-6 space-y-6">
                        <div>
                            ...
                            @error('base_distance_km') <span class="text-xs text-red-600 dark:text-red-400">{{ $message }}</span> @enderror
                        ...
                        <div>
                            ...
                            @error('base_price') <span class="text-xs text-red-600 dark:text-red-400">{{ $message }}</span> @enderror
                        ...
                        <div>
                            ...
                            @error('price_per_km') <span class="text-xs text-red-600 dark:text-red-400">{{ $message }}</span> @enderror
