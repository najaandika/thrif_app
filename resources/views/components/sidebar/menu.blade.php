...
<div class="{{ $mobile ? 'p-4' : '' }}">
    ...
    <nav class="space-y-1">
        <a href="{{ route('dashboard') }}" @if($mobile) wire:navigate.stop @click="$dispatch('close-drawer')" @endif class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('dashboard') || request()->is('dashboard') ? $activeClasses : $inactiveClasses }}">
        ...
        <a href="{{ route('pos.index') }}" @if($mobile) wire:navigate.stop @click="$dispatch('close-drawer')" @endif class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('pos.*') ? $activeClasses : $inactiveClasses }}">
            <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('categories.index') }}" @if($mobile) wire:navigate.stop @click="$dispatch('close-drawer')" @endif class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('categories.*') ? $activeClasses : $inactiveClasses }}">
            <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('settings.index') }}" @if($mobile) wire:navigate.stop @click="$dispatch('close-drawer')" @endif class="group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('settings.*') ? $activeClasses : $inactiveClasses }}">
            <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
