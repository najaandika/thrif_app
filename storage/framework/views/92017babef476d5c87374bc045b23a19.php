<?php if($showModal && $selectedTransaction): ?>
            ...
            <div class="modal-body">
                ...
                <div class="receipt-section">
                    ...
                    <div class="receipt-items">
                        <?php $__currentLoopData = $selectedTransaction->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="receipt-item-detail">
                                        ...
                                        <?php if($isDiscounted): ?>
                                            <div class="flex items-center gap-2 mt-0.5">
                                                <span class="text-xs bg-red-100 text-red-600 px-1.5 py-0.5 rounded font-bold">-<?php echo e($discountPercent); ?>%</span>
                                                <span class="text-xs text-gray-400 line-through"><?php echo e(rupiah($originalPrice)); ?></span>
                                                <span class="text-red-600 font-bold"><?php echo e(rupiah($item->price)); ?></span>
                                            </div>
                                            <div class="text-[10px] text-gray-500 mt-0.5"><?php echo e($item->qty); ?> x <?php echo e(rupiah($item->price)); ?></div>
                                        <?php else: ?>
                                            <?php echo e($item->qty); ?> x <?php echo e(rupiah($item->price)); ?>

                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="receipt-item-subtotal font-semibold"><?php echo e(rupiah($item->subtotal)); ?></div>
                            </div>
                ...
                <div class="receipt-section receipt-summary">
                    ...
                    <?php if($selectedTransaction->discount > 0): ?>
                        <div class="receipt-row">
                    ...
                    <?php if($selectedTransaction->payment_method === 'cash'): ?>
                        <div class="receipt-row">
                ...
                <?php if($selectedTransaction->notes): ?>
                    <div class="receipt-section">
...
<?php endif; ?><?php /**PATH C:\laragon\www\thrif\resources\views\livewire\transactions\_modal.blade.php ENDPATH**/ ?>