                ...
                <div class="settings-card-body">
                    ...
                    <div class="tab-navigation">
                            <div class="flex space-x-2 mb-6">
                                    <button type="button" wire:click="$set('activeTab', 'shop')" class="px-4 py-2 rounded-xl font-semibold text-sm focus:outline-none transition-all duration-200 shadow-sm hover:shadow-md <?php echo e($activeTab === 'shop' ? 'bg-gray-900 dark:bg-gray-700 text-white' : 'bg-transparent text-gray-700 dark:text-white hover:bg-slate-100 dark:hover:bg-slate-800'); ?>">
                                        Informasi Toko
                                    </button>
                                    <button type="button" wire:click="$set('activeTab', 'social')" class="px-4 py-2 rounded-xl font-semibold text-sm focus:outline-none transition-all duration-200 shadow-sm hover:shadow-md <?php echo e($activeTab === 'social' ? 'bg-gray-900 dark:bg-gray-700 text-white' : 'bg-transparent text-gray-700 dark:text-white hover:bg-slate-100 dark:hover:bg-slate-800'); ?>">
                                        Social Media
                                    </button>
                                    <button type="button" wire:click="$set('activeTab', 'operational')" class="px-4 py-2 rounded-xl font-semibold text-sm focus:outline-none transition-all duration-200 shadow-sm hover:shadow-md <?php echo e($activeTab === 'operational' ? 'bg-gray-900 dark:bg-gray-700 text-white' : 'bg-transparent text-gray-700 dark:text-white hover:bg-slate-100 dark:hover:bg-slate-800'); ?>">
                                        Operasional
                                    </button>
                                    <button type="button" wire:click="$set('activeTab', 'about')" class="px-4 py-2 rounded-xl font-semibold text-sm focus:outline-none transition-all duration-200 shadow-sm hover:shadow-md <?php echo e($activeTab === 'about' ? 'bg-gray-900 dark:bg-gray-700 text-white' : 'bg-transparent text-gray-700 dark:text-white hover:bg-slate-100 dark:hover:bg-slate-800'); ?>">
                                        Tentang Kami
                                    </button>
                            </div>
                    </div>
