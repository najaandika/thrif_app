<div class="mb-6 flex flex-col lg:flex-row gap-4 lg:items-center justify-between">
    ...
    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full lg:w-auto">
        <div class="flex flex-row gap-2">
            <form action="<?php echo e(route('transactions.export.excel')); ?>" method="GET" class="inline-block">
            ...
            <form action="<?php echo e(route('transactions.export.pdf')); ?>" method="GET" target="_blank" class="inline-block">
                <input type="hidden" name="search" value="<?php echo e($search ?? ''); ?>">
                <button type="submit"
...
</div><?php /**PATH C:\laragon\www\thrif\resources\views\livewire\transactions\_filters.blade.php ENDPATH**/ ?>