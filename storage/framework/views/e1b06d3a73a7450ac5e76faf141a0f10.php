                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr class="hover:bg-indigo-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                                    ...
                                                    <td class="px-6 py-4 text-right">
                                                        <button type="button" wire:click="addToCart(<?php echo e($product->id); ?>)" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-xs font-semibold rounded-lg shadow-md hover:from-indigo-600 hover:to-purple-600 hover:shadow-lg transition-all duration-200 hover:scale-105">
                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr class="hover:bg-indigo-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                                <td class="px-6 py-4">
                                                    <div class="text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo e($item['name']); ?></div>
                                                </td>
                                                <td class="px-6 py-4">
                                                    <input type="number" min="1" wire:model.lazy="cartQty.<?php echo e($item['id']); ?>" class="w-20 px-3 py-2 border-2 border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all">
                                                </td>
                                                <td class="px-6 py-4">
                                                    <div class="text-sm text-gray-900 dark:text-gray-100">Rp <?php echo e(number_format($item['price'], 0, ',', '.')); ?></div>
                                                </td>
                                                <td class="px-6 py-4">
                                                    <div class="text-sm font-semibold text-gray-900 dark:text-gray-100">Rp <?php echo e(number_format($item['price'] * $item['qty'], 0, ',', '.')); ?></div>
                                                </td>
                                                <td class="px-6 py-4 text-right">
                                                    <button type="button" wire:click="removeFromCart(<?php echo e($item['id']); ?>)" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs font-semibold rounded-lg hover:from-red-600 hover:to-pink-600 shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105">
                                                        <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="bg-white dark:bg-gray-800/50 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm space-y-6">
                            ...
                            <div class="pt-6 border-t-2 border-gray-200 dark:border-gray-700 space-y-3">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="text-2xl font-bold text-indigo-600 dark:text-indigo-400">Rp <?php echo e(number_format($total, 0, ',', '.')); ?></span>
                                </div>
                                <div class="flex justify-between items-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl">
                                    ...
                                    <span class="text-lg font-bold text-green-600 dark:text-green-400">Rp <?php echo e(number_format($change, 0, ',', '.')); ?></span>
                                </div>
                            </div>
                        </div>
