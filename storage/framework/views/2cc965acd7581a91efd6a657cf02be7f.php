<div>
    ...
    <div 
        x-data="{ 
            ...
            downloadReceipt() {
                ...
                // Assuming html2canvas is loaded globally
                ...
                html2canvas(element, {
                    ...
                    link.download = 'Receipt-' + '<?php echo e($order->invoice_number); ?>' + '.jpg';
    ...
    >
        ...
        <div class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-sm mx-auto overflow-hidden transition-all transform" 
            ...
            <!-- Close Button -->
            <button wire:click="closeModal" class="absolute top-4 right-4 z-20 p-2 rounded-full bg-gray-100 dark:bg-gray-700/80 text-gray-500 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors focus:outline-none">
                ...
                <div id="receipt-content" class="bg-white p-4 border border-gray-100 rounded-sm">
                    ...
                    <div class="space-y-1 mb-6">
                         ...
                         <div class="flex justify-between text-xs text-gray-500 pt-2">
                            ...
                            <span><?php echo e($order->payment_method === 'cash' ? 'COD' : 'Non-Tunai (Midtrans)'); ?></span>
                        </div>
...
<?php /**PATH C:\laragon\www\thrif\resources\views/livewire/orders/customer-receipt-modal.blade.php ENDPATH**/ ?>