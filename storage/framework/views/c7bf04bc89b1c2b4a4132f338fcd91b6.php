    ...
    <div class="rounded-3xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-md p-4 sm:p-5">
        <div class="flex flex-wrap items-center gap-2 justify-between mb-4 text-xs text-gray-500 dark:text-gray-400">
            ...
            <div class="flex items-center gap-2">
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('landing.products.index')); ?>" class="text-[11px] text-indigo-600 dark:text-indigo-400 hover:underline inline-flex items-center gap-1">
                    Lihat Semua
        ...
        <div class="relative" data-carousel-wrapper>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $featuredProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div data-product-card data-product-category="<?php echo e($product->category); ?>" data-product-link="<?php echo e($product->getActionLink()); ?>" class="group rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden flex flex-col min-w-[240px] max-w-[240px] snap-center transition-all duration-300 hover:shadow-xl hover:shadow-indigo-500/20 hover:scale-[1.02] hover:border-indigo-300 dark:hover:border-indigo-600" data-carousel-item>
                    <div class="relative w-full aspect-[4/3] overflow-hidden flex-shrink-0">
                        <?php if($product->image): ?>
                            <img src="<?php echo e(Storage::url($product->image)); ?>" alt="<?php echo e($product->name); ?>" loading="lazy" width="240" height="180" class="absolute inset-0 h-full w-full object-cover transition-transform duration-500 group-hover:scale-110">
                        <?php else: ?>
                        ...
                        <div class="flex-1 space-y-2">
                            ...
                            <div class="flex items-center gap-2 text-[11px]">
                                <span class="inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-white font-bold shadow-sm
                                    <?php echo e($product->condition_class); ?>">
                        ...
                        <div class="flex items-center justify-between mt-auto pt-2 border-t border-gray-100 dark:border-gray-700">
                            <div>
                                <?php if($product->is_on_sale): ?>
                                    ...
                                    <span data-product-price class="text-base font-bold text-red-500"><?php echo e(rupiah($product->final_price)); ?></span>
                                <?php else: ?>
                                    <span data-product-price class="text-base font-bold text-green-600"><?php echo e(rupiah($product->price)); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <?php if($product->is_available): ?>
                            <div class="mt-4 flex items-center justify-center">
                                <div class="flex gap-2 w-full max-w-[220px]">
                                    <form action="<?php echo e(route('landing.cart.store')); ?>" method="POST" class="flex-1">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <a href="<?php echo e(route('landing.products.checkout', ['product' => $product, 'from' => 'home'])); ?>"
