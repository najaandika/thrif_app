<section class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-6 space-y-5">
        ...
        <div class="space-y-2">
            ...
            <?php if($product->is_on_sale): ?>
                <div class="pt-2">
                    ...
                    <p class="text-3xl font-bold text-red-500"><?php echo e(rupiah($product->final_price)); ?></p>
    ...
    <div class="rounded-2xl bg-gray-50 dark:bg-gray-800/70 p-4 text-xs text-gray-600 dark:text-gray-300 space-y-1">
        <p>Stok tersedia: <span class="font-semibold"><?php echo e($product->sizes->isNotEmpty() ? $product->total_stock : $product->stock); ?></span></p>
...
<?php /**PATH C:\laragon\www\thrif\resources\views\landing\components\product-info.blade.php ENDPATH**/ ?>