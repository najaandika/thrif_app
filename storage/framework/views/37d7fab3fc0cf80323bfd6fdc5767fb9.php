...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <!-- New Image -->
                            <div>
                                <label for="image" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2"><?php echo e($product->image ? 'Replace Main Image' : 'Main Product Image'); ?></label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <!--[if BLOCK]><![endif]--><?php if(in_array($img->id, $imagesToDelete)): ?> <?php continue; ?> <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <div class="relative group aspect-square">
                                            <img src="<?php echo e(Storage::url($img->image_path)); ?>" class="h-full w-full object-cover rounded-xl border border-gray-200 dark:border-gray-600">
                                            <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity rounded-xl flex items-center justify-center">
                                                <button type="button" wire:click="deleteExistingImage(<?php echo e($img->id); ?>)" 
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $additionalImagePreviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $preview): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="relative group aspect-square">
                                            <img src="<?php echo e($preview); ?>" class="h-full w-full object-cover rounded-xl border-2 border-indigo-500 dark:border-indigo-400">
                                            <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity rounded-xl flex items-center justify-center">
                                                <button type="button" wire:click="removeNewAdditionalImage(<?php echo e($index); ?>)" 
                                                    class="p-2 bg-red-500 text-white rounded-full hover:bg-red-600 transition shadow-sm"
                                                    title="Remove Upload">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['newAdditionalImages.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-xs text-red-600 dark:text-red-400"><?php echo e($message); ?></span> <?php unset($message);
