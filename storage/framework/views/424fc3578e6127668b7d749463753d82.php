            ...
            <div class="flex-1 min-w-0 px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Edit Order #<?php echo e(str_pad($order->id, 4, '0', STR_PAD_LEFT)); ?></h2>
                        ...
                        <form wire:submit="update" id="orderForm">
                            <div class="space-y-6">
                                <div class="flex items-center justify-between">
                                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Order #<?php echo e(str_pad($order->id, 4, '0', STR_PAD_LEFT)); ?></h2>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="flex flex-col justify-end">
                                        ...
                                        <p class="text-2xl font-bold text-gray-900 dark:text-white">Rp <?php echo e(number_format($previewTotal, 0, ',', '.')); ?></p>
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <select wire:model="payment_status" id="payment_status" class="mt-1 block w-full rounded-xl border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500">
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $paymentStatusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($value); ?>"><?php echo e($label); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                        </select>
...
<?php /**PATH C:\laragon\www\thrif\resources\views/livewire/orders/edit.blade.php ENDPATH**/ ?>