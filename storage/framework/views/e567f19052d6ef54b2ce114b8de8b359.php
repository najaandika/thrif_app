<?php if($showModal && $selectedOrder): ?>
<div 
    x-data='receiptModal(<?php echo json_encode($this->receiptConfig, 15, 512) ?>)'
        ...
        <div class="p-6 overflow-y-auto max-h-[80vh]">
            ...
            <div id="receipt-content" class="bg-white p-4 border border-gray-100 rounded-sm">
                ...
                <div class="flex justify-between text-xs mb-1">
                    ...
                    <span class="font-mono font-medium text-gray-900"><?php echo e($selectedOrder->invoice_number); ?></span>
                </div>
                <div class="flex justify-between text-xs mb-4">
                    <span class="text-gray-500">Tanggal</span>
                    <span class="font-medium text-gray-900"><?php echo e($selectedOrder->created_at->format('d/m/Y H:i')); ?></span>
                </div>
                ...
                <div class="space-y-3 mb-4">
                    ...
                    <div class="text-sm">
                        <div class="flex items-start justify-between gap-2">
                            ...
                            <?php if($wasDiscounted && $item->product && $item->product->discount_percentage): ?>
                ...
                <div class="space-y-1 mb-6">
                    ...
                    <?php if($selectedOrder->type === 'pos'): ?>
                        ...
                        <?php if($selectedOrder->discount > 0): ?>
                            <?php
                        ...
                        <div class="flex justify-between text-xs text-red-500 pt-1">
                            <span>Diskon (<?php echo e($percentage); ?>%)</span>
                            <span>- <?php echo e(number_format($selectedOrder->discount, 0, ',', '.')); ?></span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex justify-between text-sm font-bold text-gray-900 pt-1">
                            <span>TOTAL</span>
                            <span class="text-gray-900">Rp <?php echo e(number_format($selectedOrder->total_price, 0, ',', '.')); ?></span>
                        </div>

                        <!-- Payment -->
                        <?php if($selectedOrder->type === 'pos' && $selectedOrder->payment_method === 'cash'): ?>
                    ...
                    <?php else: ?>
                        ...
                        <div class="flex justify-between text-xs text-gray-500 pt-2">
                            <span>Nama</span>
                            <span class="font-medium text-gray-900"><?php echo e($selectedOrder->buyer_name); ?></span>
                        </div>
                        <?php endif; ?>

                        <div class="flex justify-between text-xs text-gray-500 pt-2">
                            <span>Pengiriman</span>
                            <span><?php echo e($selectedOrder->shipping_address === 'AMBIL DI TOKO' ? 'Ambil di Toko' : 'Pesan Antar'); ?></span>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="flex justify-between text-xs text-gray-500 pt-2">
                        ...
                        <span class="font-bold text-gray-900 uppercase">
                            ...
                            <?php elseif($selectedOrder->payment_method === 'cash'): ?>
                                <?php if($selectedOrder->shipping_address === 'AMBIL DI TOKO'): ?>
                                    Bayar di Kasir
                                <?php else: ?>
                                    COD
                                <?php endif; ?>
                    ...
                    <div class="flex justify-between text-xs text-gray-500 pt-1">
                        <span>Kontak</span>
                        <span class="font-medium text-gray-900"><?php echo e($selectedOrder->buyer_contact ?? '-'); ?></span>
                    </div>
                    <?php endif; ?>

                    <?php if($selectedOrder->shipping_address && $selectedOrder->type !== 'pos'): ?>
                    ...
                    <div class="flex justify-between text-xs text-gray-500 pt-1 text-right">
                        ...
                        <span class="font-medium text-gray-900 ml-4 italic">"<?php echo e($selectedOrder->notes); ?>"</span>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="flex justify-between text-xs text-gray-500 pt-1">
                        <span>Status</span>
                        <span class="font-bold <?php echo e($selectedOrder->status === 'paid' ? 'text-emerald-600' : ($selectedOrder->status === 'pending' ? 'text-amber-600' : 'text-gray-600')); ?>">
                            <?php echo e(strtoupper($selectedOrder->status_label ?? $selectedOrder->status)); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\thrif\resources\views\livewire\orders\_modal.blade.php ENDPATH**/ ?>