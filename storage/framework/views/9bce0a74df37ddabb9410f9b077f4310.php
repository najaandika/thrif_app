<header id="main-header" class="w-full border-b border-gray-200 dark:border-gray-800 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md transition-all duration-200 sticky top-0 z-[100]">
    <div class="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 h-14 lg:h-16 flex items-center justify-between">
        ...
        <nav class="hidden lg:flex items-center gap-5 text-[13px] font-medium text-gray-600 dark:text-gray-300">
            ...
            <a href="<?php echo e(route('landing.products.index', ['promo' => 1])); ?>" class="smooth-scroll hover:text-gray-900 dark:hover:text-gray-100 inline-flex items-center gap-1">
        ...
        <div class="flex items-center gap-2 lg:gap-3">
            ...
            <a href="<?php echo e(route('landing.cart.index')); ?>" class="flex h-9 w-9 lg:h-10 lg:w-10 items-center justify-center rounded-2xl border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 relative transition-transform hover:scale-105 active:scale-95 hover:opacity-80 transition-all" aria-label="Cart">
                ...
                <span data-cart-count class="absolute -top-1 -right-1 h-5 w-5 rounded-full bg-red-500 text-[10px] font-bold text-white flex items-center justify-center <?php echo e(session('cart_count', 0) > 0 ? '' : 'hidden'); ?>"><?php echo e(session('cart_count', 0)); ?></span>
            </a>
    ...
    <div id="mobile-nav" class="lg:hidden hidden border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
        <div class="px-4 py-4 space-y-4 text-sm text-gray-700 dark:text-gray-200">
            <div class="grid gap-3">
                ...
                <a href="<?php echo e(route('landing.products.index', ['promo' => 1])); ?>" class="flex items-center gap-1">Flash Sale <span class="text-orange-500">🔥</span></a>
