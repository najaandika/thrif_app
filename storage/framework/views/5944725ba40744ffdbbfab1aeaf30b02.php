                        ...
                        <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="flex py-4 first:pt-0 last:pb-0 gap-4">
                                <div class="h-24 w-24 flex-shrink-0 overflow-hidden rounded-2xl border border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 relative">
                                    ...
                                    <?php endif; ?>
                                    <?php if(isset($item['is_on_sale']) && $item['is_on_sale']): ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="space-y-1" x-show="deliveryMethod === 'shipping'" x-transition>
                            ...
                            <?php $__errorArgs = ['shippingAddress'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
</div><?php /**PATH C:\laragon\www\thrif\resources\views\livewire\landing\cart.blade.php ENDPATH**/ ?>