        ...
        <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="space-y-4">
                <div class="flex items-center gap-3">
                    <?php if($shopLogo): ?>
                        <img src="<?php echo e(Storage::url($shopLogo)); ?>" alt="<?php echo e($shopName); ?>" class="h-10 w-10 rounded-2xl object-cover shadow-lg flex-shrink-0">
                    <?php else: ?>
            ...
            <div class="space-y-3">
                ...
                <ul class="space-y-2 text-xs text-gray-600 dark:text-gray-400">
                    ...
                    <li><a href="<?php echo e(route('landing.products.index')); ?>" class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors inline-block">Catalog</a></li>
            ...
            <div class="space-y-3">
                ...
                <div class="space-y-2.5">
                    <?php if($shopEmail): ?>
                    <a href="mailto:<?php echo e($shopEmail); ?>" class="group flex items-start gap-2.5 text-xs text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                    ...
                    <?php if($shopPhone): ?>
                    <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $shopPhone)); ?>" class="group flex items-start gap-2.5 text-xs text-gray-600 dark:text-gray-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                        <div class="flex-shrink-0">
        ...
        <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
                <p class="text-xs text-gray-500 dark:text-gray-400 text-center sm:text-left">
                    &copy; <?php echo e(date('Y')); ?> <?php echo e($shopName); ?>. All rights reserved. Made with ❤️ for thrift lovers.
                </p>
...
<?php /**PATH C:\laragon\www\thrif\resources\views/landing/sections/footer.blade.php ENDPATH**/ ?>