            ...
            <div class="admin-content">
                <div class="admin-card">
                    <div class="admin-card-body">
                        <?php echo $__env->make('livewire.products._filters', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php echo $__env->make('livewire.products._table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
