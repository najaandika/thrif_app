<div class="profile-section">
    <!--[if BLOCK]><![endif]--><?php if(session()->has('addressSaved')): ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="flex flex-wrap items-center gap-4">
            ...
            <!--[if BLOCK]><![endif]--><?php if($hasAddress && $lastUpdatedHuman): ?>
                <p class="text-sm text-gray-500 dark:text-gray-400">Terakhir diperbarui <?php echo e($lastUpdatedHuman); ?>.</p>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        </div>
    </form>
</div>
<?php /**PATH C:\laragon\www\thrif\resources\views/livewire/profile/address-form.blade.php ENDPATH**/ ?>